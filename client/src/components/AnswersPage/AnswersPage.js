...
function AnswersPage({ selectedQuestion, setCurrentPage, setDataBaseUpdateTrigger, tags, isGuest }) {
	...
	useEffect(() => {
		if (selectedQuestion) {
			axios
				.get(`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/votes`)
				.then((response) => {
	...
	useEffect(() => {
		if (selectedQuestion) {
			axios
				.get(
					`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/answers`
				)
				.then((response) => {
...
function QuestionWrapper({ selectedQuestion, questionVotes, setQuestionVotes, registeredUser, tidToTagName, isGuest }) {
	...
	function handleQuestionUpvote() {
		axios
			.put(
				`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/users/${userId}/upvote`
			)
			.then((response) => {
	...
	function handleQuestionDownvote() {
		axios
			.put(
				`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/users/${userId}/downvote`
			)
			.then((response) => {
				if (response.data.success) {
					setQuestionVotes(questionVotes - 1);
	...
	const questionAddComment = (e) => {
		if (e.key === "Enter") {
			...
			axios
				.post(
					`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/users/${userId}/comments`,
					{
						text: newComment,
		...
		const getQuestion = async () => {
			try {
				const response = await axios.get(
					`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}`
				);
			} catch (error) {
				console.error(error);
			}
...
function QuestionCommentsWrapper({ selectedQuestion, newCommentCounter, registeredUser }) {
	...
	useEffect(() => {
		try {
			axios
				.get(
					`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/comments`
				)
				.then((response) => {
...
function AnswerCommentsWrapper({ selectedQuestion, answer, newCommentCounter, registeredUser }) {
	...
	useEffect(() => {
		try {
			axios
				.get(
					`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/answers/${answer._id}/comments`
				)
				.then((response) => {
					setComments(Object.values(response.data).sort((a, b) => new Date(b.time) - new Date(a.time)));
				})
...
function Comment({ commentId, commentText, commentAuthor, commentVotes, registeredUser }) {
	...
	function handleCommentUpvote() {
		axios
			.put(`https://coordinated-care-cce88007d728.herokuapp.com/api/comments/${commentId}/users/${userId}/upvote`)
			.then((response) => {
				if (response.data.success) {
					setVotes(votes + 1);
				} else {
...
function Answer({
	...
	const answerAddComment = (e) => {
		if (e.key === "Enter") {
			...
			axios
				.post(
					`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/answers/${answerKey}/users/${userId}/comments`,
					{
						text: newComment,
						author: Cookie.get("auth"),
					}
	...
	function handleAnswerUpvote() {
		axios
			.put(
				`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/answers/${answerKey}/users/${userId}/upvote`
			)
			.then((response) => {
				if (response.data.success) {
					setVotes(votes + 1);
	...
	function handleAnswerDownvote() {
		axios
			.put(
				`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/answers/${answerKey}/users/${userId}/downvote`
			)
			.then((response) => {
				if (response.data.success) {
					setVotes(votes - 1);
	...
	useEffect(() => {
		const getAnswer = async () => {
			try {
				const response = await axios.get(
					`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${selectedQuestion._id}/answers/${answerKey}`
				);
