...
function QuestionBox({
	...
	function handleQuestionUpvote() {
		axios
			.put(`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${questions._id}/upvote`)
			.then((response) => {
	...
	function handleQuestionDownvote() {
		axios
			.put(`https://coordinated-care-cce88007d728.herokuapp.com/api/questions/${questions._id}/downvote`)
			.then((response) => {
				const updatedQuestion = response.data;
				setQuestionVotes(updatedQuestion.votes);
			})
