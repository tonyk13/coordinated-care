...
export default function EditQuestionPage({ 
    ...
    const handlePostQuestionButton = async (event) => {
        ...
        if (!pqNE1 && !pqNE2 && !pqHLE1 && !pqNE3 && !pqTE1 && !pqNE4) {
            ...
            try {
                const pqResponse = await axios.put(`http://localhost:8000/api/questions/${eqid}`, postQuestion, {
                  headers: {
                    'Content-Type': 'application/json',
                  }
                });
    ...
    return (
        <div id="editQuestionPage">
            <form id="editQuestionForm">
                <div>
                    <label className="editQuestionLabels">
                        Question Title*
                    </label>
                    <label className="editQuestionSubLabels">
                ...
                <span id="editQuestionLastLine">
                    ...
                    <button
                        type="button"
                        id="returnQuestionButton"
                        onClick={handleReturnQuestionButton}
                    >
                        Return
                    </button>
                    <button
                        ...
                        onClick={handleDeleteQuestionButton}
                    >
                        Delete Question
                    </button>
                    <span id="editQuestionErrors">
