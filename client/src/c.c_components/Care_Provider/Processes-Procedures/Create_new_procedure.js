...
export default function CreateNewProcedure({ setCurrentPage }) {
		...
		<Container>
			...
			<form onSubmit={handleSubmit}>
				...
				<FormControl fullWidth sx={{ mb: 2 }}>
					...
					<Select value={procedureType} label="Type" onChange={handleProcedureTypeChange}>
				...
				<Button onClick={() => setCurrentPage("Procedures")} variant="outlined" sx={{ ml: 2 }}>
					Cancel
				</Button>
			</form>
		</Container>
