...
exports.all_employees = async (req, res, next) => {
	try {
...
exports.update_privacy_settings = async (req, res, next) => {
	...
	try {
		const employee = await employeeModel.findByIdAndUpdate(employee_id, { privacySettings });
...
exports.update_notification_settings = async (req, res, next) => {
	...
	try {
		const employee = await employeeModel.findByIdAndUpdate(employee_id, { notificationSettings });
